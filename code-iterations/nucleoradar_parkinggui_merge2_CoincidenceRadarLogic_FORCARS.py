...
def cluster_lot_indices(car_clusters):
    # Returns a set of lot indices where clusters are found
    lot_indices = set()
            ...
            if data:
                ...
                while True:
                    ...
                    if result[0] == TC_PASS:
                        ...
                        if car_detected:
                            cluster_lots = cluster_lot_indices(car_clusters)
